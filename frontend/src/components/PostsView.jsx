      ...
      <div className="flex flex-col w-100 bg-white relative">
        ...
        <div className="flex flex-col space-y-0.5 m-2 text-sm font-semibold text-gray-500 items-center">
          <div className="flex flex-row space-x-1">
            <div className="flex my-auto"><img className="w-8 h-8 p-0.5 rounded-full mx-auto" src={userImagePath ? "http://localhost:4000/" + userImagePath : "https://static.vecteezy.com/system/resources/previews/020/765/399/non_2x/default-profile-account-unknown-icon-black-silhouette-free-vector.jpg"} /></div>
